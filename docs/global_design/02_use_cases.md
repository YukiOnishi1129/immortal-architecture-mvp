...
- **検索対象**
  - タイトル（ノートのタイトル）
  - 本文（テンプレートの各セクションにユーザーが自由入力した文字列）
    ※テンプレートのセクション名（例：問題・原因・対策）は検索対象に含めない

- **検索方法**
  - 部分一致（LIKE検索 or 簡易全文検索）
  - 検索語を含むノートを一覧で表示
